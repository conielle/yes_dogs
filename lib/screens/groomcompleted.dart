...
class GroomCompleted extends StatefulWidget {
  static const String id = 'groomcompleted';

  @override
  _GroomCompletedState createState() => _GroomCompletedState();
}

class _GroomCompletedState extends State<GroomCompleted>
...
//    mapRead['my_column'] = 1;
  ...
  dateChecker(){
    if(rescheduleddate == null){_removeGroomDate();} else if (rescheduleddate != null){_rescheduleByWeeks();}
  }
  timeChecker(){
    if (finalTime == null){_removeGroomTime();} else if (finalTime != null){_updateGroomTime();}
  }

  void _rescheduleByWeeks() async {
    if (rescheduleddate == null) {} else if (rescheduleddate != null) {
      Map<String, dynamic> row = {
  ...
  void _removeGroomDate() async {
    Map<String, dynamic> row = {
      DatabaseHelper.columnId: (indexID),
      DatabaseHelper.columnScheduleDate: "Date",
    };
    final rowsAffected = await dbHelper.updateDoggos(row);
  }

  void _removeGroomTime() async {
    Map<String, dynamic> row = {
      DatabaseHelper.columnId: (indexID),
      DatabaseHelper.columnScheduleTime: "Time",
    };
    final rowsAffected = await dbHelper.updateDoggos(row);
  }
...
/////////1 Week////////////
  void oneweek() {
    ...
    (month == feb) {
      if (day <= 21 && day >= 1) {
        finalday =
        (february() == 29) ? (february() + day - 30 + 22 - 14) : (february() +
            day - 30 + 7);
      }
      else if (day == 22) {
        ...
        finalday =
        (february() == 29) ? (february() + day - 37 - 14) : (february() + day -
            37 - 14);
      }
...
//////////////2 Weeks//////////////
  void twoweek() {
    ...
    (month == feb) {
      if (day <= 14 && day >= 1) {
        finalday =
        (february() == 29) ? (february() + day - 30 + 22 - 7) : (february() +
            day - 30 + 14);
      }
      else if (day == 15) {
        finalday = ((february() == 29 ? (29) : 1));
        ...
        finalday =
        (february() == 29) ? (february() + day - 37 - 7) : (february() + day -
            37 - 7);
      }
...
////////3 Week//////////////
  void threeweek() {
    ...
    (month == feb) {
      if (day <= 7 && day >= 1) {
        finalday =
        (february() == 29) ? (february() + day - 30 + 22) : (february() + day -
            30);
      }
      else if (day == 8) {
        finalday = ((february() == 29 ? (29) : 1));
        ...
        finalday =
        (february() == 29) ? (february() + day - 37) : (february() + day - 37);
      }
  ...
  void fourweek() {
    ...
    (month == feb) {
      if (day == 1) {
        ...
        finalday =
        (february() == 29) ? (february() + day - 30) : (february() + day - 30);
      }
...
////////////5 Week////////////////
  void fiveweek() {
    ...
    (month == mar) {
      ...
      result = (day >= 27) ? '$finalday-$ma-$resyear' : (day >= 27)
          ? '$finalday-$ma-$resyear'
          : '$finalday-$apr-$resyear';
    ...
    (month == apr) {
      ...
      result = (day >= 26) ? '$finalday-$jun-$resyear' : (day >= 26)
    ...
    (month == ma) {
      ...
      result = (day >= 27) ? '$finalday-$jul-$resyear' : (day >= 27)
    ...
    (month == jun) {
      ...
      result = (day >= 26) ? '$finalday-$aug-$year' : (day >= 26)
          ? '$finalday-$aug-$year'
          : '$finalday-$jul-$year';
    ...
    (month == jul) {
      ...
      result = (day >= 28) ? '$finalday-$sep-$resyear' : (day >= 28)
    ...
    (month == aug) {
      ...
      result = (day >= 27) ? '$finalday-$oct-$resyear' : (day >= 27)
    ...
    (month == sep) {
      ...
      result = (day >= 26) ? '$finalday-$nov-$resyear' : (day >= 26)
    ...
    (month == oct) {
      ...
      result = (day >= 27) ? '$finalday-$dec-$resyear' : (day >= 27)
    ...
    (month == nov) {
      ...
      newyear = resyear + 1;
      result = (day >= 26) ? '$finalday-$jan-$newyear' : (day >= 26)
    ...
    (month == dec) {
      ...
      newyear = resyear + 1;
      result = (day >= 27) ? '$finalday-$feb-$newyear' : (day >= 27)
...
/////////6 Week//////////
  void sixweek() {
    ...
    (month == mar) {
      ...
      result = (day >= 21) ? '$finalday-$ma-$resyear' : (day >= 21)
          ? '$finalday-$ma-$resyear'
          : '$finalday-$apr-$resyear';
    ...
    (month == apr) {
      ...
      result = (day >= 20) ? '$finalday-$jun-$resyear' : (day >= 20)
          ? '$finalday-$jun-$resyear'
          : '$finalday-$ma-$resyear';
    ...
    (month == ma) {
      ...
      result = (day >= 21) ? '$finalday-$jul-$resyear' : (day >= 21)
          ? '$finalday-$jul-$resyear'
          : '$finalday-$jun-$resyear';
    ...
    (month == jun) {
      ...
      result = (day >= 20) ? '$finalday-$aug-$year' : (day >= 20)
          ? '$finalday-$aug-$year'
          : '$finalday-$jul-$year';
    ...
    (month == jul) {
      ...
      result = (day >= 21) ? '$finalday-$sep-$resyear' : (day >= 21)
          ? '$finalday-$sep-$resyear'
          : '$finalday-$aug-$resyear';
    ...
    (month == aug) {
      ...
      result = (day >= 21) ? '$finalday-$oct-$resyear' : (day >= 21)
          ? '$finalday-$oct-$resyear'
          : '$finalday-$sep-$resyear';
    ...
    (month == sep) {
      ...
      result = (day >= 20) ? '$finalday-$nov-$resyear' : (day >= 20)
          ? '$finalday-$nov-$resyear'
          : '$finalday-$oct-$resyear';
    ...
    (month == oct) {
      ...
      result = (day >= 21) ? '$finalday-$dec-$resyear' : (day >= 21)
          ? '$finalday-$dec-$resyear'
          : '$finalday-$nov-$resyear';
    ...
    (month == nov) {
      ...
      newyear = resyear + 1;
      result = (day >= 20) ? '$finalday-$jan-$newyear' : (day >= 20)
          ? '$finalday-$jan-$newyear'
          : '$finalday-$dec-$resyear';
    ...
    (month == dec) {
      ...
      newyear = resyear + 1;
      result = (day >= 21) ? '$finalday-$feb-$newyear' : (day >= 21)
          ? '$finalday-$feb-$newyear'
          : '$finalday-$jan-$newyear';
...
/////////7 Week//////////////////
  void sevenweek() {
    ...
    (month == mar) {
      ...
      result = (day >= 13) ? '$finalday-$ma-$resyear' : (day >= 13)
          ? '$finalday-$ma-$resyear'
          : '$finalday-$apr-$resyear';
    ...
    (month == apr) {
      ...
      result = (day >= 13) ? '$finalday-$jun-$resyear' : (day >= 13)
          ? '$finalday-$jun-$resyear'
          : '$finalday-$ma-$resyear';
    ...
    (month == ma) {
      ...
      result = (day >= 13) ? '$finalday-$jul-$resyear' : (day >= 13)
          ? '$finalday-$jul-$resyear'
          : '$finalday-$jun-$resyear';
    ...
    (month == jun) {
      ...
      result = (day >= 13) ? '$finalday-$aug-$year' : (day >= 13)
          ? '$finalday-$aug-$year'
          : '$finalday-$jul-$year';
    ...
    (month == jul) {
      ...
      result = (day >= 14) ? '$finalday-$sep-$resyear' : (day >= 14)
          ? '$finalday-$sep-$resyear'
          : '$finalday-$aug-$resyear';
    ...
    (month == aug) {
      ...
      result = (day >= 13) ? '$finalday-$oct-$resyear' : (day >= 13)
          ? '$finalday-$oct-$resyear'
          : '$finalday-$sep-$resyear';
    ...
    (month == sep) {
      ...
      result = (day >= 14) ? '$finalday-$nov-$resyear' : (day >= 14)
          ? '$finalday-$nov-$resyear'
          : '$finalday-$oct-$resyear';
    ...
    (month == oct) {
      ...
      result = (day >= 13) ? '$finalday-$dec-$resyear' : (day >= 13)
          ? '$finalday-$dec-$resyear'
          : '$finalday-$nov-$resyear';
    ...
    (month == nov) {
      ...
      result = (day >= 13) ? '$finalday-$jan-$newyear' : (day >= 13)
          ? '$finalday-$jan-$newyear'
          : '$finalday-$dec-$resyear';
    ...
    (month == dec) {
      ...
      newyear = resyear + 1;
      result = (day >= 13) ? '$finalday-$feb-$newyear' : (day >= 13)
          ? '$finalday-$feb-$newyear'
          : '$finalday-$jan-$newyear';
...
////////8 Weeks//////////
  void eightweek() {
    ...
    (month == mar) {
      ...
      result = (day >= 6) ? '$finalday-$ma-$resyear' : (day >= 6)
          ? '$finalday-$ma-$resyear'
          : '$finalday-$ma-$resyear';
    ...
    (month == apr) {
      ...
      result = (day >= 6) ? '$finalday-$jun-$resyear' : (day >= 6)
          ? '$finalday-$jun-$resyear'
          : '$finalday-$ma-$resyear';
    ...
    (month == ma) {
      ...
      result = (day >= 6) ? '$finalday-$jul-$resyear' : (day >= 6)
          ? '$finalday-$jul-$resyear'
          : '$finalday-$jun-$resyear';
    ...
    (month == jun) {
      ...
      result = (day >= 6) ? '$finalday-$aug-$year' : (day >= 6)
          ? '$finalday-$aug-$year'
          : '$finalday-$jul-$year';
    ...
    (month == jul) {
      ...
      result = (day >= 6) ? '$finalday-$sep-$resyear' : (day >= 6)
          ? '$finalday-$sep-$resyear'
          : '$finalday-$aug-$resyear';
    ...
    (month == aug) {
      ...
      result = (day >= 6) ? '$finalday-$oct-$resyear' : (day >= 6)
          ? '$finalday-$oct-$resyear'
          : '$finalday-$sep-$resyear';
    ...
    (month == sep) {
      ...
      result = (day >= 6) ? '$finalday-$nov-$resyear' : (day >= 6)
          ? '$finalday-$nov-$resyear'
          : '$finalday-$oct-$resyear';
    ...
    (month == oct) {
      ...
      result = (day >= 6) ? '$finalday-$dec-$resyear' : (day >= 6)
          ? '$finalday-$dec-$resyear'
          : '$finalday-$nov-$resyear';
    ...
    (month == nov) {
      ...
      newyear = resyear + 1;
      result = (day >= 6) ? '$finalday-$jan-$newyear' : (day >= 6)
          ? '$finalday-$jan-$newyear'
          : '$finalday-$dec-$resyear';
    ...
    (month == dec) {
      ...
      newyear = resyear + 1;
      result = (day >= 7) ? '$finalday-$feb-$newyear' : (day >= 7)
          ? '$finalday-$feb-$newyear'
          : '$finalday-$jan-$newyear';
  ...
  void nineweek() {
    ...
    if (month == jan) {
      if (day <= 28 && day >= 1) {
        ...
        finalday =
        (february() == 29) ? (february() - 26) + day - mth3 : (february() -
            27) + day - mth3;
      }
    ...
    (month == mar) {
      ...
      result = (day >= 30) ? '$finalday-$jun-$resyear' : (day >= 30)
          ? '$finalday-$jun-$resyear'
          : '$finalday-$ma-$resyear';
    ...
    (month == apr) {
      ...
      result = (day >= 29) ? '$finalday-$jul-$resyear' : (day >= 29)
          ? '$finalday-$jul-$resyear'
          : '$finalday-$jun-$resyear';
    ...
    (month == ma) {
      ...
      result = (day >= 30) ? '$finalday-$aug-$resyear' : (day >= 30)
          ? '$finalday-$aug-$resyear'
          : '$finalday-$jul-$resyear';
    ...
    (month == jun) {
      ...
      result = (day >= 29) ? '$finalday-$sep-$year' : (day >= 29)
          ? '$finalday-$sep-$year'
          : '$finalday-$aug-$year';
    ...
    (month == jul) {
      ...
      result = (day >= 30) ? '$finalday-$oct-$resyear' : (day >= 30)
          ? '$finalday-$oct-$resyear'
          : '$finalday-$sep-$resyear';
    ...
    (month == aug) {
      ...
      result = (day >= 30) ? '$finalday-$nov-$resyear' : (day >= 30)
          ? '$finalday-$nov-$resyear'
          : '$finalday-$oct-$resyear';
    ...
    (month == sep) {
      ...
      result = (day >= 29) ? '$finalday-$dec-$resyear' : (day >= 29)
          ? '$finalday-$dec-$resyear'
          : '$finalday-$nov-$resyear';
    ...
    (month == oct) {
      ...
      result = (day >= 30) ? '$finalday-$jan-$newyear' : (day >= 30)
          ? '$finalday-$jan-$newyear'
          : '$finalday-$dec-$resyear';
    ...
    (month == nov) {
      ...
      result = (day >= 30) ? '$finalday-$feb-$newyear' : (day >= 30)
          ? '$finalday-$feb-$resyear'
          : '$finalday-$jan-$newyear';
    ...
    (month == dec) {
      ...
      newyear = resyear + 1;
      result =
      (day >= 29 && newyearleap() == 29) ? '$finalday-$mar-$newyear' : (day >=
          28 && newyearleap() == 30)
  ...
  void tenweek() {
    ...
    if (month == jan) {
      if (day <= 20 && day >= 1) {
        ...
        finalday =
        (february() == 29) ? (february() - 26) + 8 + day - mth3 : (february() -
            27) + 8 + day - mth3;
      }
    ...
    (month == feb) {
      if (day <= 19 && day >= 1) {
        finalday =
        (february() == 29) ? ((february() - 28) + 2 + (day) + actualday + 46) -
            40 : ((february() - 28) + 3 + (day) + actualday + 45) - 40;
      }
      else if (day == 20) {
    ...
    (month == mar) {
      ...
      result = (day >= 23) ? '$finalday-$jun-$resyear' : (day >= 23)
          ? '$finalday-$jun-$resyear'
          : '$finalday-$ma-$resyear';
    ...
    (month == apr) {
      ...
      result = (day >= 22) ? '$finalday-$jul-$resyear' : (day >= 22)
          ? '$finalday-$jul-$resyear'
          : '$finalday-$jun-$resyear';
    ...
    (month == ma) {
      ...
      result = (day >= 23) ? '$finalday-$aug-$resyear' : (day >= 23)
          ? '$finalday-$aug-$resyear'
          : '$finalday-$jul-$resyear';
    ...
    (month == jun) {
      ...
      result = (day >= 23) ? '$finalday-$sep-$year' : (day >= 23)
          ? '$finalday-$sep-$year'
          : '$finalday-$aug-$year';
    ...
    (month == jul) {
      ...
      result = (day >= 23) ? '$finalday-$oct-$resyear' : (day >= 23)
          ? '$finalday-$oct-$resyear'
          : '$finalday-$sep-$resyear';
    ...
    (month == aug) {
      ...
      result = (day >= 23) ? '$finalday-$nov-$resyear' : (day >= 23)
          ? '$finalday-$nov-$resyear'
          : '$finalday-$oct-$resyear';
    ...
    (month == sep) {
      ...
      result = (day >= 22) ? '$finalday-$dec-$resyear' : (day >= 23)
          ? '$finalday-$dec-$resyear'
          : '$finalday-$nov-$resyear';
    ...
    (month == oct) {
      ...
      result = (day >= 23) ? '$finalday-$jan-$newyear' : (day >= 23)
          ? '$finalday-$jan-$newyear'
          : '$finalday-$dec-$resyear';
    ...
    (month == nov) {
      ...
      result = (day >= 23) ? '$finalday-$feb-$newyear' : (day >= 23)
          ? '$finalday-$feb-$resyear'
          : '$finalday-$jan-$newyear';
    ...
    (month == dec) {
      ...
      result =
      (day >= 22 && newyearleap() == 29) ? '$finalday-$mar-$newyear' : (day >=
          21 && newyearleap() == 30)
          ? '$finalday-$mar-$newyear'
          : '$finalday-$feb-$newyear';
  ...
  void elevenweek() {
    ...
    if (month == jan) {
      if (day <= 14 && day >= 1) {
        ...
        finalday =
        (february() == 29) ? (february() - 26) + 14 + day - mth3 : (february() -
            27) + 14 + day - mth3;
      }
      result = (february() == 29 && day >= 15)
          ? '$finalday-$apr-$resyear'
    ...
    (month == feb) {
      if (day <= 13 && day >= 1) {
        finalday =
        (february() == 29) ? ((february() - 28) + 3 + (day) + actualday + 46) -
            34 : ((february() - 28) + 5 + (day) + actualday + 45) - 35;
      }
      else if (day == 13) {
        finalday = (february() == 29) ? (31) : (01);
      }
    ...
    (month == mar) {
      ...
      result = (day >= 16) ? '$finalday-$jun-$resyear' : (day >= 16)
          ? '$finalday-$jun-$resyear'
          : '$finalday-$ma-$resyear';
    ...
    (month == apr) {
      ...
      result = (day >= 15) ? '$finalday-$jul-$resyear' : (day >= 15)
          ? '$finalday-$jul-$resyear'
          : '$finalday-$jun-$resyear';
    ...
    (month == ma) {
      ...
      result = (day >= 16) ? '$finalday-$aug-$resyear' : (day >= 16)
          ? '$finalday-$aug-$resyear'
          : '$finalday-$jul-$resyear';
    ...
    (month == jun) {
      ...
      result = (day >= 16) ? '$finalday-$sep-$year' : (day >= 16)
          ? '$finalday-$sep-$year'
          : '$finalday-$aug-$year';
    ...
    (month == jul) {
      ...
      result = (day >= 16) ? '$finalday-$oct-$resyear' : (day >= 16)
          ? '$finalday-$oct-$resyear'
          : '$finalday-$sep-$resyear';
    ...
    (month == aug) {
      ...
      result = (day >= 16) ? '$finalday-$nov-$resyear' : (day >= 16)
          ? '$finalday-$nov-$resyear'
          : '$finalday-$oct-$resyear';
    ...
    (month == sep) {
      ...
      result = (day >= 15) ? '$finalday-$dec-$resyear' : (day >= 15)
          ? '$finalday-$dec-$resyear'
          : '$finalday-$nov-$resyear';
    ...
    (month == oct) {
      ...
      result = (day >= 16) ? '$finalday-$jan-$newyear' : (day >= 16)
          ? '$finalday-$jan-$newyear'
          : '$finalday-$dec-$resyear';
    ...
    (month == nov) {
      ...
      result = (day >= 16) ? '$finalday-$feb-$newyear' : (day >= 16)
          ? '$finalday-$feb-$resyear'
          : '$finalday-$jan-$newyear';
    ...
    (month == dec) {
      ...
      result =
      (day >= 15 && newyearleap() == 29) ? '$finalday-$mar-$newyear' : (day >=
          14 && newyearleap() == 30)
          ? '$finalday-$mar-$newyear'
          : '$finalday-$feb-$newyear';
  ...
  void twelveweek() {
    ...
    if (month == jan) {
      if (day <= 7 && day >= 1) {
        ...
        finalday =
        (february() == 29) ? (february() - 26) + 21 + day - mth3 : (february() -
            27) + 21 + day - mth3;
      }
      result = (february() == 29 && day >= 8)
          ? '$finalday-$apr-$resyear'
    ...
    (month == feb) {
      if (day <= 5 && day >= 1) {
        finalday =
        (february() == 29) ? ((february() - 28) + 10 + (day) + actualday + 46) -
            34 : ((february() - 28) + 12 + (day) + actualday + 45) - 35;
      }
      else if (day == 6) {
        finalday = (february() == 29) ? (30) : (01);
      }
      ...
      result =
      (february() == 29 && day >= 7) ? '$finalday-$ma-$resyear' : (february() ==
          30 && day >= 6)
          ? '$finalday-$ma-$resyear'
          : '$finalday-$apr-$resyear';
    ...
    (month == mar) {
      ...
      result = (day >= 9) ? '$finalday-$jun-$resyear' : (day >= 9)
          ? '$finalday-$jun-$resyear'
          : '$finalday-$ma-$resyear';
    ...
    (month == apr) {
      ...
      result = (day >= 8) ? '$finalday-$jul-$resyear' : (day >= 8)
          ? '$finalday-$jul-$resyear'
          : '$finalday-$jun-$resyear';
    ...
    (month == ma) {
      ...
      result = (day >= 9) ? '$finalday-$aug-$resyear' : (day >= 9)
          ? '$finalday-$aug-$resyear'
          : '$finalday-$jul-$resyear';
    ...
    (month == jun) {
      ...
      result = (day >= 9) ? '$finalday-$sep-$year' : (day >= 9)
          ? '$finalday-$sep-$year'
          : '$finalday-$aug-$year';
    ...
    (month == jul) {
      ...
      result = (day >= 10) ? '$finalday-$oct-$resyear' : (day >= 10)
          ? '$finalday-$oct-$resyear'
          : '$finalday-$sep-$resyear';
    ...
    (month == aug) {
      ...
      result = (day >= 10) ? '$finalday-$nov-$resyear' : (day >= 9)
          ? '$finalday-$nov-$resyear'
          : '$finalday-$oct-$resyear';
    ...
    (month == sep) {
      ...
      result = (day >= 8) ? '$finalday-$dec-$resyear' : (day >= 8)
          ? '$finalday-$dec-$resyear'
          : '$finalday-$nov-$resyear';
    ...
    (month == oct) {
      ...
      result = (day >= 9) ? '$finalday-$jan-$newyear' : (day >= 9)
          ? '$finalday-$jan-$newyear'
          : '$finalday-$dec-$resyear';
    ...
    (month == nov) {
      ...
      result = (day >= 9) ? '$finalday-$feb-$newyear' : (day >= 9)
          ? '$finalday-$feb-$newyear'
          : '$finalday-$jan-$newyear';
    ...
    (month == dec) {
      ...
      result =
      (day >= 8 && newyearleap() == 29) ? '$finalday-$mar-$newyear' : (day >=
          7 && newyearleap() == 30)
          ? '$finalday-$mar-$newyear'
          : '$finalday-$feb-$newyear';
